...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Update message service got called");
		...
		System.out.println("Change Message request JSON : " + json);
		
    	Message mail = MPSUtil.mapper.readValue(json, Message.class);
		    
		Response changeMailResponse = new MessageDao().updateMessage(mail);
